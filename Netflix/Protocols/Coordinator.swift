...
extension Coordinator {
    ...
    func finishWith(splashEvent: SplashViewController.Event) {
        childCoordinators.removeAll()
        finishDelegate?.coordinatorDidFinish(childCoordinator: self, splashEvent: splashEvent)
    }
}
